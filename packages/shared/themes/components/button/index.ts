export const buttonFilled = (color: string) => {
  return `bg-${color}-600 text-black shadow-2xl shadow-${color}-900 hover:shadow-lg hover:bg-${color}-600/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none`;
};
...
export const buttonOutlined = (color: string) =>
  `border border-${color}-600 text-${color}-600 hover:opacity-75 focus:ring focus:ring-${color}-200 active:opacity-[0.85]`;

export const buttonText = (color: string) =>
  `text-${color}-600 hover:bg-${color}-600/10 active:bg-${color}-600/30`;
