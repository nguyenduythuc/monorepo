...
import useCifInfoPendingCheck from '@lfvn-customer/shared/hooks/useCifInfoPendingCheck';

const CifInfoPendingCheckScreen = ({
  flowId,
  productCode,
}: {
  flowId: string;
...
export default CifInfoPendingCheckScreen;
