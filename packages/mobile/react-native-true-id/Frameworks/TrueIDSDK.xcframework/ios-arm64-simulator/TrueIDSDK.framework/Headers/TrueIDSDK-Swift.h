...
SWIFT_CLASS("_TtC9TrueIDSDK18NfcResultNoExtract")
@interface NfcResultNoExtract : NSObject
@property (nonatomic, copy) NSString * _Nonnull nfcData;
@property (nonatomic, strong) NSNumber * _Nonnull code;
@property (nonatomic, copy) NSString * _Nonnull errorMessage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (void)startNFCC06WithIdnumber:(NSString * _Nonnull)idnumber dob:(NSString * _Nonnull)dob doe:(NSString * _Nonnull)doe listenerNFC:(void (^ _Nonnull)(NfcResult * _Nonnull))listenerNFC;
+ (void)startNFCNoExtractWithIdnumber:(NSString * _Nonnull)idnumber dob:(NSString * _Nonnull)dob doe:(NSString * _Nonnull)doe listenerNFCNoExtract:(void (^ _Nonnull)(NfcResultNoExtract * _Nonnull))listenerNFCNoExtract;
